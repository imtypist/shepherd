...
// Include the trusted shepherd header that is generated
// during the build. This file is generated by calling the
// sdk tool oeedger8r against the shepherd.edl file.
#include "shepherd_t.h"

// This is the function that the host calls. It prints
// a message in the enclave before calling back out to
// the host to print a message from there too.
void enclave_shepherd()
{
    ...
    oe_result_t result = host_shepherd();
    if (result != OE_OK)
    {
        fprintf(
            stderr,
            "Call to host_shepherd failed: result=%u (%s)\n",
            result,
